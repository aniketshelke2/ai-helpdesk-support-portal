...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "helpdesk/ticket/tickets/test/integration/FirstJourney",
    "helpdesk/ticket/tickets/test/integration/TicketsListJourney",
    "helpdesk/ticket/tickets/test/integration/TicketsObjectPageJourney",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
